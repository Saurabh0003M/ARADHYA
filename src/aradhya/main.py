...
from src.aradhya.commands.parasite import handle_parasite
...
COMMAND_TABLE: list[tuple[list[str], callable]] = [
    ...
    (["/parasite candidates", "parasite candidates"], handle_parasite),
    (["/parasite inspect", "parasite inspect"], handle_parasite),
    (["/parasite ledger", "parasite ledger"], handle_parasite),
    (["/parasite digest", "parasite digest"], handle_parasite),
    (["/parasite resume", "parasite resume"], handle_parasite),
    (["/parasite absorb", "parasite absorb"], handle_parasite),
    (["/parasite gc", "parasite gc"], handle_parasite),
    (["/parasite dedup", "parasite dedup"], handle_parasite),
    (["/parasite status", "parasite status", "/parasite", "parasite"], handle_parasite),
